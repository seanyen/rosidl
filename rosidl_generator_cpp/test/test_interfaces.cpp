...
TEST(Test_rosidl_generator_traits, has_fixed_size) {
  ...
  static_assert(
    rosidl_generator_traits::has_fixed_size<rosidl_generator_cpp::msg::PrimitivesUnset>::value,
    "PrimitivesUnset::has_fixed_size is false");
  ...
  static_assert(
    ...
    "PrimitivesUnsetArray::has_fixed_size is false");
...
TEST(Test_rosidl_generator_traits, has_bounded_size) {
  ...
  static_assert(
    rosidl_generator_traits::has_bounded_size<rosidl_generator_cpp::msg::PrimitivesUnset>::value,
    "PrimitivesUnset::has_bounded_size is false");
  ...
  static_assert(
    rosidl_generator_traits::has_bounded_size<
      rosidl_generator_cpp::msg::PrimitivesStatic>::value,
    "PrimitivesUnsetArray::has_bounded_size is false");
...
void test_message_primitives_unset(rosidl_generator_cpp::msg::PrimitivesUnset message)
{
...
TEST(Test_messages, primitives_static) {
  rosidl_generator_cpp::msg::PrimitivesUnset message;
  test_message_primitives_unset(message);
}
